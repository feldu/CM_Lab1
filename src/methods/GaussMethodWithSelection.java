...
import io.LinearSystemWriter;
import linearSystem.LinearSystem;

import java.util.Arrays;

/**
 * Gauss method with selection diagonal elements by the column
 */
public class GaussMethodWithSelection implements SolvingMethod {
    LinearSystemWriter out;

    public GaussMethodWithSelection(LinearSystemWriter out) {
        this.out = out;
    }
    ...
    public void solve(LinearSystem linearSystem) {
        ...
        out.printInfo("Треугольный вид матрицы:");
        out.printMatrix(a, b);
        ...
        out.printInfo("Определитель: " + det);
        //Обратный ход
